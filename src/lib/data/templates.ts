...
export const MEME_TEMPLATES: MemeTemplate[] = [
  ...
  },
  {
    ...
    tags: ['is-this-a-pigeon', 'anime', 'three-text', 'impact-font'],
    category: 'classic',
    difficulty: 'easy',
  },
  {
    id: 'monkey-puppet',
    name: 'Monkey Puppet',
    description: 'Awkward side-eye vs. staring — two captions for the calm and the panicked puppet',
  ...
  },
  {
    ...
    description: 'Setup in the white strip (two lines) plus a caption over the reaction frame',
  ...
  },
  {
    id: 'think-about-it',
    name: 'Think About It',
    description: 'Roll Safe / temple tap — top setup and bottom punchline',
  ...
  },
  {
    id: 'x-x-everywhere',
    name: 'X, X Everywhere',
    description: 'Toy Story eyes — label what you see, then the everywhere punchline',
